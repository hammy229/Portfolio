...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.timeline-item, .project-card, .skill-category, .education-item, .certification-card, .contact-info, .contact-form');
...
if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
        ...
        // Create mailto link
        const mailtoLink = `mailto:avd745@my.utexas.edu?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(
            `Name: ${name}\nEmail: ${email}\n\nMessage:\n${message}`
        )}`;
...
console.log(`
🚀 Welcome to Arham V. Doshi's Portfolio!
📧 Contact: avd745@my.utexas.edu
🔗 LinkedIn: linkedin.com/in/arhamdoshi
💼 Open to opportunities in AI/ML and NLP research
`);
...
// Add reactive text effects
document.addEventListener('DOMContentLoaded', () => {
    const titles = document.querySelectorAll('.section-title, .hero-title');
    titles.forEach(title => {
        title.addEventListener('mouseenter', function() {
            this.style.textShadow = '0 0 30px rgba(99, 102, 241, 0.8)';
        });
        
        title.addEventListener('mouseleave', function() {
            this.style.textShadow = '0 0 20px rgba(99, 102, 241, 0.3)';
        });
    });
});

// Add reactive button effects
document.addEventListener('DOMContentLoaded', () => {
...
// Add reactive card effects
document.addEventListener('DOMContentLoaded', () => {
    const cards = document.querySelectorAll('.project-card, .skill-category, .timeline-content, .education-item, .certification-card');
    cards.forEach(card => {
